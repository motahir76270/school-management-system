...
import { getStudentClassNotesList } from '@/hooks/apiCalls/student'
...
const StudentClassNotes = () => {
  ...
  const handleClassNotesList = useCallback(async (subjectId?: string) => {
  ...
  const renderEmptyComponent = useCallback(() => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptySubtitle}>
        {selectedSubject ? 'No notes available for this subject' : 'Please select a subject'}
      </Text>
    </View>
  ), [selectedSubject])
