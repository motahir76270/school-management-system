...
import { getStudentsAdminCardPdfById } from '@/hooks/apiCalls/student';
...
const ReportCardPreview = () => {
  ...
  const loadHTML = async (id: any) => {
    try {
      console.log('Loading URL:', id);
      setLoading(true);
      setError(false);

      const response = await getStudentsAdminCardPdfById(id)
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <HeaderSection title="Admit Card" />
